	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<c:choose>
					<c:when test="${val=='add' }">
						<td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：下载中心  &gt; 上传文档</td>
					</c:when>
					<c:otherwise>
						<td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：下载中心  &gt; 更新文档</td>
					</c:otherwise>
				</c:choose>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx }/document/saveOrUpdateDocument.action" enctype="multipart/form-data" method="post">
                    <!-- 隐藏表单，flag表示添加标记 -->
