		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${pageModel.list}" var="employee" varStatus="stat">
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id }" name="employeeIds"></td>
					 <td>${employee.name }</td>
					  <td>
					        <c:choose>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/updateEmployee.action?flag=1&id=${employee.id}">
