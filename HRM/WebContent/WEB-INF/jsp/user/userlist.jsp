					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						...
						<tr>
							<td class="fftd">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td id="selectInfo" class="font3">登录名：<input type="text" name="loginname"
											value="${user.loginname}" />&nbsp;&nbsp;用户名：<input
											type="text" name="username" value="${user.username}" />
											用户状态：<input type="text" name="status" value="${user.status eq 0 ? '':user.status }"><input
								...
								<c:choose>
									<c:when test='${sessionScope.user_session.username=="超级管理员" }'>
										<td align="center" width="40px;">
											<a href="${ctx}/viewUser.action?id=${user.id}">
